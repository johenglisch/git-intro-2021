...
\title{Version control and data curation with Git and GitHub}
\author[Johannes Englisch]{%
  Johannes Englisch\\%
  {\footnotesize%
    \href{mailto:englisch@shh.mpg.de}%
    {{\usebeamercolor[fg]{ssh-grey}englisch@shh.mpg.de}}%
  }%
}
\institute{%
...
\setbeamercolor{institute}{fg=shh-grey}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-1.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-2.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-3.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-4.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-5.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-6.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \centering{%
    \includegraphics[width=.89\textwidth]{images/branches-7.jpg}%
  }
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Repository for these slides right here:\\
      \href{https://github.com/johenglisch/git-intro-2021}%
      {https:/\kern-.5ex/github.com/johenglisch/git-intro-2021}
  \end{itemize}
\end{frame}
